<template>
  <div class="login">
    ...
    <figure>
      <div id="onglets">
        <div class="onglet"> Se connecter </div>
        <div class="onglet"> S'inscrire </div>
      </div>
      <form action="">
...
<style scoped>
  ...
  .onglet {
    background-color: rgba(253, 45, 1, 0.5);
    width: 40%;
  ...
  button:hover {
    background-color: rgba(253, 45, 1, 0.7);
  }
/*/////////// RESPONSIVITY /////////////*/
